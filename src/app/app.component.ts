...
export class AppComponent {
  works = {
    masks: [
      {
        author: 'Александра Буглакова', title: 'From Russia with love', pictures: [
        ...
        descr: 'темпера; переплетный картон, микрогофрокартон, аэрозольная краска, акрил\n' +
          '2022\n' +
          '\n' +
          'История с кокошниками получилась довольно личной, она отражает важные для меня части жизни. На каждом кокошнике есть символ, связанный с этими частями. Казалось бы, темы совершенно разные (история, культура и искусство, религия, люди), но их объединяет понятие “дом”. Я хотела поделиться именно тем, что дает мне ощущение нахождения дома, безопасности, спокойствия.\n'
      },
      {
        author: 'Глеб Кива', title: 'Anonymity', pictures: [
          'assets/images/masks/Глеб1.JPG',
          'assets/images/masks/Глеб2.JPG',
          'assets/images/masks/Глеб3.JPG',
          'assets/images/masks/Глеб4.JPG',
        ],
        descr: 'темпера; гофрокартон, бумага, акрил, горячий клей\n' +
          '2022\n' +
          '\n' +
          'Листая комментарии, смотря трансляции и слушая музыку я редко задумываюсь о личности, которая стоит за их созданием. В основу моей работы легла мысль о том, что действие совершенное анонимно никому не принадлежит. Все фигуры на маске, кроме треугольника на месте рта заполнены скриншотами контента, произведенного анонимно.\n'
      },
      {
        author: 'Алиса Голованова', title: 'emotional masking', pictures: [
    ...
    future: [
      {
        author: 'Василиса', title: 'Предчувствие эволюции', pictures: [
        ...
        author: 'Никита', title: 'Прошлое/будущее', pictures: [
          'assets/images/future/nikita.JPG',
        ],
        descr: 'Цветная бумага; акварель; линеры; пастель; лампа\n' +
          '2022\n' +
          '\n' +
          'Тема Большого террора и памяти о нем волнует меня с детства. Я чувствую, что не могу не говорить об этом. Проект состоит из двух работ: карта и пейзаж. На карте, якобы принадлежащей руководителю вымышленной экспедиции, отмечены места захоронений на расстрельном полигоне. Мы видим только фрагмент карты. Остальной части у нас нет, и мы не знаем, что там.\n' +
        ...
        author: 'Александра Буглакова', title: 'The only vocation', pictures: [
          'assets/images/future/sasha.jpg',
        ],
        descr: 'бумага для черчения, линеры, цветные маркеры, акварельные карандаши\n' +
          '2021\n' +
          '\n' +
          'Люди стремятся к собственному благополучию, независимости. Они пытаются превзойти общество и самих себя. К чему это приведет? Формируются отдельные группы, так называемые “кружки по интересам”. Такие общества находятся в одном пространстве, но никогда друг с другом не пересекаются и не взаимодействуют.\n'
      },
      {
    ...
    avangard: [
      {
        author: 'Александра Буглакова', title: 'Кони топотом торопливо шепотом', pictures: [
        ...
        descr: 'коллаж, аппликация; цветная бумага, пробойник, люверсы\n' +
          '2022\n' +
          '\n' +
          'Давид Бурлюк (1882-1967) являлся одним из основоположников футуризма в России, он писал манифесты, издавал экспериментальные сборники и организовывал выставки. \n' +
      ...
      {
        author: 'Никита', title: 'Кинетический супрематизм', pictures: [
    ...
    books: [
      ...
      {
        author: 'Алиса Голованова', title: 'покидая дом', pictures: [
        ...
        descr: 'коллаж (бумага / фотошоп)\n' +
          '2022\n' +
          '\n' +
          'Мне кажется, если в жизни человека происходит что-то необычное, об этом необходимо оставлять след. Записывать не факты, а эмоции, чувства и ассоциации, передавать своё уникальное восприятие. В день отъезда из Москвы я начала делать фотографии, понимая, что хочу сделать из них какой-то проект, и сделала книгу о том, как я уехала (и вернулась). Я побывала в ОАЭ и Шри-Ланке и постаралась передать моё восприятие каждой из стран через динамику, цвет и шрифт в разворотах.\n'
      },
      {
        author: 'Алиса П.', title: 'leave it in my dreams', pictures: [
        ...
        descr: 'фотографии, пиксель-арт рисунки, гуашь, маркеры, чьи-то принты, нитки\n' +
          '2022\n' +
          '\n' +
          'Сны, мечты и другие проявления подсознания всегда привлекали меня как тема. Я много мечтаю, придумывая истории – иногда так забываюсь в себе. Это может как помогать мне создавать сюжеты для своих работ, так и мешать – я теряю чувство реальности. Что вообще такое реальность?\n' +
